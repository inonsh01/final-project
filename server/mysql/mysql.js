...
//         fs.readdir("/home/hilma/Desktop/Hilma's-Projects/projects/finalProject/server/mysql/entities", (err, files) => {
//             if (err) throw err;
//             files.forEach(file => {
//                 let buffer = fs.readFileSync(`/home/hilma/Desktop/Hilma's-Projects/projects/finalProject/server/mysql/entities/${file}`);
//                 if (err) throw err;
